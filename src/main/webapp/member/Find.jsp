...
<head>
    ...
    function confirmId(){
    	...
    	form.method="post";
    	form.action="FindIdProcessT.jsp";
    	form.submit()
    }
    function confirmPass(){
    	var form = document.writeFrm;
    	form.method="post";
    	form.action="FindPassProcessT.jsp";
    	form.submit()
    }
...
<div id="AllWrap">
    ...
    <div style="margin-top:20px;">
        <input type="button" value="아이디 찾기 &gt;" id="btn" onclick="confirmId();">
        <input type="button" value="비밀번호 찾기 &gt;" id="btn" onclick="confirmPass();">
    </div>
</div>
</body>
</html>